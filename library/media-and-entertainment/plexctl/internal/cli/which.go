...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  plexctl-pp-cli which "stale tickets"
  plexctl-pp-cli which "bottleneck"
  plexctl-pp-cli which --limit 1 "send message"
  plexctl-pp-cli which                                # list the full capability index`,
