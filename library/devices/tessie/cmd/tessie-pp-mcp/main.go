...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/devices/tessie/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("TESSIE_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "tessie-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
